...
- Bing Wu, Dan Feng, Wei Tong, Jingning Liu, Chengning Wang, **Wei Zhao**, Mengye Peng, ReRAM Crossbar-Based Analog Computing Architecture for Naive Bayesian Engine],  IEEE 37th International Conference on Computer Design (**ICCD**), 2019.(CCF B)<button type="button" class="btn btn-ibfo">[PDF](./paper/bayes.pdf)</button>
- Chengning Wang, Dan Feng, Wei Tong, Jingning Liu, Bing Wu, **Wei Zhao**, Yang Zhang, "Design and Analysis of Address-Adaptive Read Reference Settings for Multilevel Cell Cross-Point Memory Arrays", IEEE Transactions on Electron Devices(**TED**), 2019.(SCI indexed)[test](./paper/MSST_13.pdf){: .btn .btn--info}
