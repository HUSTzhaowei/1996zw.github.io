...
- **Wei Zhao**, Wei Tong, Dan Feng, Jingning Liu, Jie Xu, Xueliang Wei, Bing Wu, Chengning Wang, Weilin Zhu, Bo Liu, OSwrite: Improving the lifetime of MLC STT-RAM with One-Step write, 36th International Conference on Massive Storage Systems and Technology (**MSST**), 2020."[PDF](./paper/MSST_13.pdf)"{: .btn .btn--info}(CCF B)<button type="button" class="btn btn-primary">原始按钮</button>
